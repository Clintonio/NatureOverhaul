...
public class EntitySheep extends EntityAnimal
{
	...
	public void updateEntityActionState() {
		...
		if(!worldObj.multiplayerWorld) {
			if((worldObj.getBlockId((int) posX, (int) posY, (int) posZ) == Block.tallGrass.blockID)
			&& (worldObj.rand.nextInt(12000) == 1)) {
				setSheared(false);
				worldObj.setBlockWithNotify((int) posX, (int) posY, (int) posZ, 0);
			}
		}
	}
