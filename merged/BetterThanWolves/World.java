    ...
    implements IBlockAccess
{
    ...
    {
        int i1 = getBlockId(i, j, k);
        if(isBlockOpaqueCube(i, j, k) && i1 != mod_FCBetterThanWolves.fcMinecartPressurePlateWood.blockID && i1 != mod_FCBetterThanWolves.fcMinecartPressurePlateStone.blockID && i1 != mod_FCBetterThanWolves.fcMinecartPressurePlateIron.blockID)
        {
