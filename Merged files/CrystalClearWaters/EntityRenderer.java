...
public class EntityRenderer
{
    ...
    private void setupFog(int i)
    {
        ...
        if(entityliving.isInsideOfMaterial(Material.water))
        {
            ...
            if(FogStrength <= 0.0F)
            {
                GL11.glFogf(2914 /*GL_FOG_DENSITY*/, 0.0F);
                float f = 0.4F;
                float f3 = 0.4F;
                float f6 = 0.9F;
                if(mc.gameSettings.anaglyph)
                {
                    float f9 = (f * 30F + f3 * 59F + f6 * 11F) / 100F;
                    float f12 = (f * 30F + f3 * 70F) / 100F;
                    float f15 = (f * 30F + f6 * 70F) / 100F;
                    f = f9;
                    f3 = f12;
                    f6 = f15;
                }
            ...
            {
                GL11.glFogf(2914 /*GL_FOG_DENSITY*/, FogStrength / 100F);
                float f1 = 0.4F;
                float f4 = 0.4F;
                float f7 = 0.9F;
                if(mc.gameSettings.anaglyph)
    ...
    //CrystalClearWaters field
    public static float FogStrength = PReader.PropFloat("/mods/Roundaround/CrystalClearWaters/CrystalClearWaters.properties", "Underwater_Fog_Strength", "2");
